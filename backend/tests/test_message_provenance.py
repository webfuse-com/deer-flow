...
class TestDynamicContextMemoryStamping:
    ...
    def test_the_memory_block_is_stamped_as_memory(self, monkeypatch):
        ...
        monkeypatch.setattr(module.DynamicContextMiddleware, "_build_full_reminder", lambda self, runtime=None, **kwargs: ("<system-reminder></system-reminder>", "some recalled memory"))
