...
class CSRFMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next: Callable[[Request], Awaitable[Response]]) -> Response:
        ...
        if should_check_csrf(request) and not _is_auth and request.headers.get("authorization") is None and not _sso_first_contact:
            ...
            # [argus patch #16] Trusted-SSO first contact is exempt too: the
            # cookie it would have to echo is minted on this very response.
